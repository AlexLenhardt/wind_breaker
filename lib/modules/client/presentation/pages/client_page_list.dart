...
class ClientPageList extends StatefulWidget {
  ...
  @override
  State<ClientPageList> createState() => _ClientPageListListPageState();
}

class _ClientPageListListPageState extends State<ClientPageList> {
  ...
  void initState() {
    super.initState();
    cubit = Modular.get<ClientCubit>();
    cubit.loadClient();
  }

  List<Client> applyFilters(List<Client> items) {
...
// Fonte da tabela
class ClientPageListDataSource extends DataTableSource {
